...
TEST_RESPONSES = [
    # ── Utah firms with revenue (will be sorted by revenue desc) ──
    {
        ...
        'largest_project_completed': 'Wasatch County Courthouse',
        'largest_project_completed_location': 'Heber',
        'largest_project_upcoming': 'Mountain View High School',
        'largest_project_upcoming_location': 'Orem',
    ...
    },
    {
        ...
        'largest_project_completed_location': 'Provo',
        'largest_project_upcoming': 'Lehi City Rec Center',
        'largest_project_upcoming_location': 'Lehi',
    ...
    },
    {
        ...
        'largest_project_completed': 'Desert Hills Community Center',
        'largest_project_completed_location': 'St. George',
        'largest_project_upcoming': 'Snow Canyon Visitor Center Expansion',
        'largest_project_upcoming_location': 'St. George',
    ...
    },
    {
        ...
        'largest_project_completed': 'Jordan Commons Office Tower Renovation',
        'largest_project_completed_location': 'Sandy',
        'largest_project_upcoming': 'Cottonwood Heights City Hall Expansion',
        'largest_project_upcoming_location': 'Cottonwood Heights',
    ...
    # ── Utah DND firms (will be sorted by employee count desc) ──
    {
        ...
        'largest_project_completed': 'Sugar House Mixed-Use Development',
        'largest_project_completed_location': 'SLC',
        'largest_project_upcoming': 'Daybreak Town Center Phase 3',
        'largest_project_upcoming_location': 'South Jordan',
    ...
    },
    {
        ...
        'largest_project_completed_location': 'Park City',
        'largest_project_upcoming': 'Kimball Junction Mixed-Use',
        'largest_project_upcoming_location': 'Park City',
    ...
    # ── Out-of-state firm (separate file) ──
    {
        ...
        'largest_project_completed_location': 'Boise',
        'largest_project_upcoming': 'Idaho Capitol Annex',
        'largest_project_upcoming_location': 'Boise',
