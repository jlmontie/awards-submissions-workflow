...
export const architectSurveyTemplate: SurveyTemplate = {
  ...
  sections: [
    ...
    {
      title: 'Revenues',
      description: 'Generated by offices located in Utah, in millions (e.g., enter 47.5 for $47.5 million). Projects outside of Utah billed to Utah-based offices should be included. Revenue figures are used for ranking. Check "Decline to Disclose" to be listed by employee count instead. See last year\'s issue at <a href="https://www.utahcdmag.com/archive#:~:text=june%202025,-VIEW%20ISSUE" target="_blank" rel="noopener noreferrer" class="text-amber-700 underline">utahcdmag.com (June 2025, page 82)</a> to see how the rankings work.',
      fields: [
