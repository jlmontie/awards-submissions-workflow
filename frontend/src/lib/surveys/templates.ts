...
export const architectSurveyTemplate: SurveyTemplate = {
  ...
  sections: [
    ...
    {
      title: 'Revenues',
      description: 'Generated by offices located in Utah, in millions (e.g., enter 47.5 for $47.5 million). Revenue figures are used for ranking. Check "Decline to Disclose" to be listed by employee count instead.',
      fields: [
