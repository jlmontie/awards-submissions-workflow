...
def main():
    ...
    print()
    print("Now add this as a new version of the terraform-managed secret shell:")
    print()
    print("  gcloud secrets versions add ucd-production-awards-user-oauth-token \\")
    print("    --data-file=/tmp/user-oauth-token.json \\")
    print("    --project=<your-project-id>")
    print()
    print("(The secret itself is created by `terraform apply`; only the version")
    print(" — this file — is added manually because it's a user credential.)")
    print()
